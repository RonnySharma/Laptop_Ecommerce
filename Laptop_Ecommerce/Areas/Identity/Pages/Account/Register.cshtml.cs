...
namespace Laptop_Ecommerce.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //Roles And Company Lists For DropDown
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                RoleList = _roleManager.Roles.Where(mul=>(mul.Name != SD.Role_Individual)&&(mul.Name!=SD.Role_Admin)).Select(r => r.Name).Select(rl => new SelectListItem()
                {
                    Text = rl,
                    Value = rl
                })
